...
| [`agent-tasks/`](agent-tasks/) | Self-contained briefs a fresh agent can pick up: `01-security-and-state-safety.md` (do first), `02-testing-and-engineering-hygiene.md` (after 01) |
